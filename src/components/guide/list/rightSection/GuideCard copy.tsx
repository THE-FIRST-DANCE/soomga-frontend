...
// import { getGuideList, getGuideListBySelected } from 'api/GuidePageAPI'
...
//   // console.log('⭐️⭐️⭐️리코일 값 selectedDatas: ', selectedDatas)
...
//     console.log('전체 리스트')
//     try {
//       const result = await getGuideList({ cursor: nowCursor, limit: 3 })
//       setNowCursor(result.nextCursor)
//       setGuideDatas((prev) => [...prev, ...result.items])
//       return result
//     } catch (error) {
//       console.error('전체 리스트 에러:', error)
//     }
//   }, [nowCursor])

//   // 🟡 필터링 리스트 🟡
//   const fetchSelectedGuideList = useCallback(async () => {
//     console.log('🟠🟠 fetchSelectedGuideList 진입')
...
//       const result = await getGuideListBySelected({ limit: 4, requestParams })

//       console.log('🟢 보낼 값 🟢 ', requestParams)
//       console.log('⭐️⭐️⭐️⭐️⭐️', result)

//       setNowCursor(result.nextCursor)
//       // setGuideDatas((prev) => [...prev, ...result.items])

//       setGuideDatas(() => [...result.items])

//       console.log('🟢🟢 fetchSelectedGuideList 실행됨')
...
//     fetchSelectedGuideList()
//   }, [selectedDatas])

//   // 객체 감지 Ref
//   const originObserveRef = useObserver(fetchOriginalGuideList)
//   const selectedObserveRef = useObserver(fetchSelectedGuideList)
...
//       <div style={{ height: '1px', width: '100%' }} ref={selectedObserveRef}></div>
//     </>
//   )
// }
